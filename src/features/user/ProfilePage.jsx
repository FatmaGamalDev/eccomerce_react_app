  ...
  return (
    <section className="flex items-center justify-center min-h-screen">
      <div className="p-6 bg-white sm:w-2/3 lg:w-1/2">
        <div className="flex flex-col items-center mb-8">
          <div className="flex items-center justify-center w-20 h-20 text-3xl font-bold text-white transition-transform duration-300 rounded-full shadow-md bg-pink hover:scale-105">
            {firstLetter}
          </div>

...
function SignUp() {
  return (
    <div className="flex items-center justify-center min-h-screen ">
      <div className="bg-white p-6 sm:w-2/3">
        ...
        <form>
          ...
          <div className="flex items-center mb-4">
            <input
              type="checkbox"
              defaultChecked
              className="accent-black mr-2 h-10  rounde-lg"
            />
          ...
          <button
            type="submit"
            className="w-full bg-pink text-white py-2 rounded-lg hover:bg-black transition"
          >
          ...
          <p className="text-2xl font-semibold    my-4 ">Quick Login</p>
          <div className="flex flex-col justify-center items-center gap-4">
            ...
            <button className=" w-full btn bg-black text-white border-[#e5e5e5]">
              <svg
